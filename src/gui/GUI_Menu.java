 ...
 * 
 * @param jp O painel (JPanel) que será mostrado.
 * 
 * Primeiro, ele ajusta o tamanho e posição do painel.  
 * Depois, limpa o fundo e adiciona o novo painel.  
 * Usa setPreferredSize() e pack() para ajustar o tamanho certinho.
 * 
 * @see #getFondo() // Precisa usar getFondo() porque "fondo" é privado.
 */
public void showMe(JPanel jp) {
    
    // Coloca o painel na posição (0,0)
    jp.setLocation(0, 0);
